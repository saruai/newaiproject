...
from get_data import read_computing, get_data
...
#Step3: Calling the computing.json & scores.json location here
    alpha = config["estimator"]["elasticnet"]["computing"]["alpha"] #computing.jason values
    l1_ratio = config["estimator"]["elasticnet"]["computing"]["l1_ratio"] #Score values
...
#Step4: Target function. Target will be confifured here
    ...
    with mlflow.start_run(run_name=mlflow_config["run_name"]) as mlosps_runs: 
        ...
        # computing_file = config["reports"]["computing"]
        ...
        # with open(computing_file, "w") as f:
        #     scores = {
        #         "alpha" : alpha,
        #         "l1_ratio" : l1_ratio,
        #     }
